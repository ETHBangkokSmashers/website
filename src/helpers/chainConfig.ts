...
export const chainConfig = {
  [sepolia.id]: {
    tradeEntryAddress: "0x7A643265a46A77Bfe7a7C62125F98CF278C7AEa9",
    tokens: {
      usdc: {
        address: "0x37EDD0C532ee8EACe797c11300a35bC7eC0a8AD5",
        decimals: 6,
      },
    },
  },
  [polygonAmoy.id]: {
    tradeEntryAddress: "0x001BF4FAfe6b4ba7091d5e6D2b4ba0671882DE31",
    tokens: {
      usdc: {
